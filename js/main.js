...
var FIELD_SIZE_X = 20,//строки
    FIELD_SIZE_Y = 20,//столбцы
    SNAKE_SPEED = 200, // Интервал между перемещениями змейки
    snake = [], // Сама змейка
    direction = 'y+', // Направление движения змейки
    gameIsRunning = false, // Запущена ли игра
    snake_timer, // Таймер змейки
    food_timer, // Таймер для еды
    score = 0, // Результат
    scoreField = document.querySelector('.score-field'); // Результат онлайн
...
function prepareGameField() {
    ...
    scoreField.innerHTML='0'; // Добавление результата
}
